...
namespace Preepex.Infrastructure.Services.Catalog
{
    public class ProductTagService : IProductTagService
    {
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(PreepexCatalogDefaults.ProductTagsByProductCacheKey, productId);
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(PreepexCatalogDefaults.ProductTagsByProductCacheKey, tagName);
        ...
        public virtual async Task<Dictionary<int, int>> GetProductCountAsync(int storeId, bool showHidden = false)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(PreepexCatalogDefaults.ProductTagCountCacheKey, storeId, "test", showHidden);
