...
using Preepex.Core.Application.Seo;
...
namespace Preepex.Infrastructure.Services
{
    public class UrlRecordService : IUrlRecordService
    {
        ...
        /// </returns>
        public async Task<string> GetActiveSlugAsync(int entityId, string entityName, int languageId)
        {
            //gradual loading
            var key = _staticCacheManager.PrepareKeyForDefaultCache(PreepexSeoDefaults.UrlRecordCacheKey, entityId, entityName, languageId);
