...
namespace Preepex.Infrastructure.Services
{
    ...
    /// </summary>
    public static partial class PreepexCommonDefaults
    {
        /// <summary>
        ...
        /// {0} : address attribute ID
        /// </remarks>
        public static CacheKey AddressAttributeValuesByAttributeCacheKey => new("Preepex.addressattributevalue.byattribute.{0}");
        ...
        /// {1} : key group
        /// </remarks>
        public static CacheKey GenericAttributeCacheKey => new("Preepex.genericattribute.{0}-{1}");
