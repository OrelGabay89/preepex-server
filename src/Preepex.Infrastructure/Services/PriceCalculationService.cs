...
using Preepex.Core.Domain.Entities.Directory;
using System;
...
namespace Preepex.Infrastructure.Services
{
    ...
    public partial class PriceCalculationService : IPriceCalculationService
    {
            ...
            DateTime? rentalEndDate)
        {
            ...
            decimal rezPrice=0;
            decimal rezPriceWithoutDiscount=0;
            ...
            if (priceWithoutDiscount < decimal.Zero)
               ...
               return (priceWithoutDiscount, price, discountAmount, appliedDiscounts);
            //});

            //return (priceWithoutDiscount, rezPrice, discountAmount, appliedDiscounts);
        }
        ...
        public virtual async Task<decimal> GetProductAttributeValuePriceAdjustmentAsync(Product product, Productattributevalue value, Customer customer, decimal? productPrice = null)
        {
            ...
            //{
            //    case AttributeValueTypeEnum.Simple:
            //        //simple attribute
        ...
        public virtual async Task<decimal> RoundPriceAsync(decimal value, Currency currency = null)
        {
            ...
            return Round(value,RoundingType.Rounding1);
        }
