...
@Component({
  selector: 'app-brand-creator-editor',
  templateUrl: './brand-creator-editor.component.html',
  encapsulation: ViewEncapsulation.None
})
export class BrandCreatorEditorComponent implements OnInit, AfterViewInit {
  ...
  constructor(private _route: ActivatedRoute,
    ...
    if (this.isEdit) {
      this.brandId = snapshot.params.id;
    }
  }
  ...
  save(): void {
    this.brandId = 'b899ec30-b85a-40ab-bb1f-18a596d5c6de';
    this.isEdit = true;
  }
  ...
  fileBrowseHandler(files): void {
    this.brand.info.picture = files[0];
  }
