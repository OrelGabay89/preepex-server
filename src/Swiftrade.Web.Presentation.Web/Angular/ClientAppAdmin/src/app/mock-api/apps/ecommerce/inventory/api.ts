...
import { brands as brandsData, categories as categoriesData, products as productsData, tags as tagsData, labels as labelsData, vendors as vendorsData } from 'app/mock-api/apps/ecommerce/inventory/data';
...
export class ECommerceInventoryMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            .onGet('api/apps/ecommerce/inventory/labels')
        ...
        this._fuseMockApiService
            .onPost('api/apps/ecommerce/inventory/label')
            .reply(({request}) => {
                // Get the label
        ...
        this._fuseMockApiService
            .onPatch('api/apps/ecommerce/inventory/label')
            .reply(({request}) => {
        ...
        this._fuseMockApiService
            .onDelete('api/apps/ecommerce/inventory/label')
            .reply(({request}) => {
                ...
                // Get the products that have the label
                const productsWithLabel = this._products.filter(product => product.labels.indexOf(id) > -1);

                // Iterate through them and delete the label
                productsWithLabel.forEach((product) => {
                    product.labels.splice(product.labels.indexOf(id), 1);
                });
