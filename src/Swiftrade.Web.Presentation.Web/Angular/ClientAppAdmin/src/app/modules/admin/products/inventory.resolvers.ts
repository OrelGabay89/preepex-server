...
export class InventoryLabelsResolver implements Resolve<any>
{
    /**
     * Constructor
     */
     ...
     * @param state
     */
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<InventoryLabel[]>
    {
        return this._inventoryService.getLabels();
    }
}
