...
namespace Preepex.Core.Application.Extensions
{
    public static class ProductExtensions
    {
        ...
        /// </remarks>
        public static IQueryable<Product> OrderBy(this IQueryable<Product> productsQuery, IGenericRepository<Localizedproperty> localizedPropertyRepository, Language currentLanguage, ProductSortingEnum orderBy)
        {
