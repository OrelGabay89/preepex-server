...
namespace Preepex.Core.Application.Media
{
    public static partial class MediaDefaults
    {
        ...
        /// {0} : thumb file name
        /// </remarks>
        public static CacheKey ThumbExistsCacheKey => new("Preepex.azure.thumb.exists.{0}", ThumbsExistsPrefix);

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string ThumbsExistsPrefix => "Preepex.azure.thumb.exists.";
