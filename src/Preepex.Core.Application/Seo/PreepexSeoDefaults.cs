...
namespace Preepex.Core.Application.Seo
{
    public static partial class PreepexSeoDefaults
    {
        /// <summary>
        ...
        /// {2} : language ID
        /// </remarks>
        public static CacheKey UrlRecordCacheKey => new("Preepex.urlrecord.{0}-{1}-{2}");
        ...
        /// {0} : slug
        /// </remarks>
        public static CacheKey UrlRecordBySlugCacheKey => new("Preepex.urlrecord.byslug.{0}");
