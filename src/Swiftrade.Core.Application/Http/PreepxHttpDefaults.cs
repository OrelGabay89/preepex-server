namespace Swiftrade.Core.Application.Http
{
    /// <summary>
    /// Represents default values related to HTTP features
    /// </summary>
    public static partial class PreepxHttpDefaults
    {
        /// <summary>
        ...
        /// </summary>
        public static string IsPostBeingDoneRequestItem => "preepex.IsPOSTBeingDone";
    }
}