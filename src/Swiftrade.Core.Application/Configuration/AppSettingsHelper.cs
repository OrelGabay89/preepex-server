...
namespace Swiftrade.Core.Application.Configuration
{
    ...
    public partial class AppSettingsHelper
    {
        ...
        public static AppSettings SaveAppSettings(IList<IConfig> configurations, IFileProvider fileProvider, bool overwrite = true)
        {
            ...
            var filePath = fileProvider.MapPath(SwiftradeConfigurationDefaults.AppSettingsFilePath);
