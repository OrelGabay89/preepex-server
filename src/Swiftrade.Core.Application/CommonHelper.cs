...
using Swiftrade.Common.Exceptions;
using System;
...
namespace Swiftrade.Core.Application
{
    public partial class CommonHelper
    {
        ...
        public static string EnsureSubscriberEmailOrThrow(string email)
        {
            ...
            {
                throw new SwiftradeException("Email is not valid.");
            }
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new SwiftradeException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
            if (!pi.CanWrite)
                throw new SwiftradeException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
        ...
        public static Interfaces.Configuration.IFileProvider DefaultFileProvider { get; set; }
