...
namespace Swiftrade.Core.Application.Seo
{
    public static partial class SwiftradeSeoDefaults
    {
        /// <summary>
        ...
        /// {2} : language ID
        /// </remarks>
        public static CacheKey UrlRecordCacheKey => new("Swiftrade.urlrecord.{0}-{1}-{2}");
        ...
        /// {0} : slug
        /// </remarks>
        public static CacheKey UrlRecordBySlugCacheKey => new("Swiftrade.urlrecord.byslug.{0}");
