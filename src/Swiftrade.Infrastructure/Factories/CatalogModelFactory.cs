...
using Swiftrade.Core.Application.Media;
...
namespace Swiftrade.Infrastructure.Factories
{
    public class CatalogModelFactory : ICatalogModelFactory
    {
        ...
        public virtual async Task<List<CategoryModel>> PrepareHomepageCategoryModelsAsync(int storeId)
        {
            ...
            var categoriesCacheKey = _staticCacheManager.PrepareKeyForDefaultCache(SwiftradeModelCacheDefaults.CategoryHomepageKey,
            ...
            var model = await _staticCacheManager.GetAsync(categoriesCacheKey, async () =>
            {
                ...
                return await homepageCategories.SelectAwait(async category =>
                {
                    ...
                    var categoryPictureCacheKey = _staticCacheManager.PrepareKeyForDefaultCache(SwiftradeModelCacheDefaults.CategoryPictureModelKey,
        ...
        public virtual async Task<List<CategorySimpleModel>> PrepareCategorySimpleModelsAsync()
        {
            ...
            var customerRoleIds = await _customerService.GetCustomerRoleIdsAsync(customer);
            var store = await _storeContext.GetCurrentStoreAsync();
            var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(SwiftradeModelCacheDefaults.CategoryAllModelKey,
        ...
        public virtual async Task<CategoryModel> PrepareCategoryModelAsync(Category category, CatalogProductsFilter filter = null)
        {
            ...
            model.SubCategories = await (await _categoryService.GetAllCategoriesByParentCategoryIdAsync(category.Id))
                .SelectAwait(async curCategory =>
                {
                    ...
                    //prepare picture model
                    var categoryPictureCacheKey = _staticCacheManager.PrepareKeyForDefaultCache(SwiftradeModelCacheDefaults.CategoryPictureModelKey, curCategory,
