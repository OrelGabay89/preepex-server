...
namespace Swiftrade.Infrastructure.Services
{
    ...
    /// </summary>
    public static partial class SwiftradeCommonDefaults
    {
        /// <summary>
        ...
        /// {0} : address attribute ID
        /// </remarks>
        public static CacheKey AddressAttributeValuesByAttributeCacheKey => new("Swiftrade.addressattributevalue.byattribute.{0}");
        ...
        /// {1} : key group
        /// </remarks>
        public static CacheKey GenericAttributeCacheKey => new("Swiftrade.genericattribute.{0}-{1}");
