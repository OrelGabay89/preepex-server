...
namespace Swiftrade.Infrastructure.Services
{
    ...
    public partial class GenericAttributeService : IGenericAttributeService
    {
        ...
        private readonly IGenericRepository<GenericAttribute> _genericAttributeRepository;
        ...
        public GenericAttributeService(IGenericRepository<GenericAttribute> genericAttributeRepository,
        ...
        {
            var key = _staticCacheManager.PrepareKeyForShortTermCache(SwiftradeCommonDefaults.GenericAttributeCacheKey, entityId, keyGroup, storeId);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task SaveAttributeAsync<TPropType>(BaseEntity<int> entity, string key, TPropType value, int storeId = 0)
        {
            if (entity == null)
        ...
        /// </returns>
        public virtual async Task<TPropType> GetAttributeAsync<TPropType>(BaseEntity<int> entity, string key, int storeId = 0, TPropType defaultValue = default)
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
