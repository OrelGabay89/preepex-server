...
namespace Swiftrade.Infrastructure.Services
{
    ...
    public partial class EmailAccountService : IEmailAccountService
    {
        ...
        public EmailAccountService(IUnitOfWork unitOfWork, IEmailAccountRepository emailAccountRepository)
        {
        ...
        public virtual async Task DeleteEmailAccountAsync(EmailAccount emailAccount)
        {
            ...
            if ((await GetAllEmailAccountsAsync()).Count == 1)
                throw new SwiftradeException("You cannot delete this email account. At least one account is required.");
