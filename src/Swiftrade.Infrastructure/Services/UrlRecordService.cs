...
using Swiftrade.Core.Application.Seo;
...
namespace Swiftrade.Infrastructure.Services
{
    public class UrlRecordService : IUrlRecordService
    {
        ...
        private readonly IGenericRepository<UrlRecord> _urlRecordRepository;
        private readonly IWorkContext _workContext;
        private readonly LocalizationSettings _localizationSettings;

        public UrlRecordService(ILanguageService languageService, IGenericRepository<UrlRecord> urlRecordRepository,
            IWorkContext workContext, IStaticCacheManager staticCacheManager, LocalizationSettings localizationSettings)
        {
        ...
        public virtual async Task<string> GetSeNameAsync<T>(T entity, int? languageId = null, bool returnDefaultValue = true,
                bool ensureTwoPublishedLanguages = true) where T : BaseEntity<int>, ISlugSupported
        {
            if (entity == null)
        ...
        public virtual async Task<Dictionary<Tuple<string, string, int>, string>> GetSeNamesAsync<T>(T[] entities, int? languageId = null, bool returnDefaultValue = true, bool ensureTwoPublishedLanguages = true) where T : BaseEntity<int>, ISlugSupported
        {
            ...
            {
                var entityName = entity.GetType().Name;
                var entityKey = _staticCacheManager.PrepareKeyForDefaultCache(SwiftradeSeoDefaults.UrlRecordCacheKey, entity.Id, entityName, langId);
    ...
    public virtual async Task<string> GetSeNameAsync(int entityId, string entityName, int? languageId = null,
        ...
        {
            //gradual loading
            var key = _staticCacheManager.PrepareKeyForDefaultCache(SwiftradeSeoDefaults.UrlRecordCacheKey, entityId, entityName, languageId);
            ...
            string slug = "", int? languageId = null, bool? isActive = null, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            var categoryPictureCacheKey =
                _staticCacheManager.PrepareKeyForDefaultCache(SwiftradeModelCacheDefaults.UrlRecordModelKey, slug, languageId, isActive, pageIndex, pageSize);
        ...
        public virtual async Task<UrlRecord> GetBySlugAsync(string slug)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(SwiftradeSeoDefaults.UrlRecordBySlugCacheKey, slug);
