...
namespace Swiftrade.Infrastructure.Services.Security
{
    public partial class AclService : IAclService
    {
        ...
        protected virtual async Task<bool> IsEntityAclMappingExistAsync<TEntity>() where TEntity : BaseEntity<int>, IAclSupported
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(SwiftradeSecurityDefaults.EntityAclRecordExistsCacheKey, entityName);
        ...
        public virtual async Task<int[]> GetCustomerRoleIdsWithAccessAsync<TEntity>(TEntity entity) where TEntity : BaseEntity<int>, IAclSupported
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(SwiftradeSecurityDefaults.AclRecordCacheKey, entityId, entityName);
