    ...
    public class CategoryService : ICategoryService
    {
        ...
        public virtual async Task<IList<Category>> GetAllCategoriesDisplayedOnHomepageAsync(int storeId, bool showHidden = false)
        {
            ...
            var storeCategoriesCacheKey = _staticCacheManager.PrepareKeyForDefaultCache(
                SwiftradeCatalogDefaults.StoreCategories,
                storeId
            );
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(SwiftradeCatalogDefaults.CategoriesAllCacheKey,
                storeId,
        ...
        {
            var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(SwiftradeCatalogDefaults.CategoriesChildIdsCacheKey,
                parentCategoryId,
                await _customerService.GetCustomerRoleIdsAsync(await _workContext.GetCurrentCustomerAsync()),
                storeId,
                showHidden);
        ...
        public virtual async Task<IList<Category>> GetCategoryBreadCrumbAsync(Category category, IList<Category> allCategories = null, bool showHidden = false)
        {
            ...
            var breadcrumbCacheKey = _staticCacheManager.PrepareKeyForDefaultCache(SwiftradeCatalogDefaults.CategoryBreadcrumbCacheKey,
                category,
                await _customerService.GetCustomerRoleIdsAsync(await _workContext.GetCurrentCustomerAsync()),
            ...
            bool showHidden = false)
        {
            ...
            }, cache => cache.PrepareKeyForDefaultCache(SwiftradeCatalogDefaults.CategoriesByParentCategoryCacheKey,
