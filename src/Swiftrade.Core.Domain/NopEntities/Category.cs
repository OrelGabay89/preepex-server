...
{
    public partial class Category : BaseEntity<int>, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported, ISoftDeletedEntity /*IDiscountSupported<DiscountCategoryMapping>*/
    {
        public Category()
        {
